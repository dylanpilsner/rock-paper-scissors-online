...
export function initResultsPage(param) {
  ...
  <the-move  state="final-choice" move="${gameState.opponentChoice}"  style="text-align:center;"></the-move>
  </div>
  <div class="my-move-container">
  <the-move state="final-choice" move=${gameState.choice}  style="text-align:center;"></the-move>
  </div>
  <div class="result-container">
  <img class="result" src="${chooseImage()}" />
  <div class="score-container">
  <h3 class="score-title">Score</h3>
  <h4 class="vos">${gameState.name}:<span class="score">${gameState.yourScore}</span></h4>
  <h4 class="bot">${gameState.opponentName}:<span class="score">${gameState.opponentScore}</span></h4>
  </div>
